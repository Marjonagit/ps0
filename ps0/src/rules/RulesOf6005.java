...
public class RulesOf6005 {
    ...
    public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
        ...
        // If you wrote the code yourself and it's required to implement, you can use it.
        if (writtenByYourself && implementationRequired) {
            return true;
        }

        // If the code is freely available and not written specifically as coursework,
        // you can use it as long as you cite your source.
        if (availableToOthers && !writtenAsCourseWork && citingYourSource) {
            return true;
        }

        // Otherwise, you may not use the code in your assignment.
        return false;
    }
